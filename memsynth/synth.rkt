        ...
        (let ([candidate (solver-check solver)])
          (cond
            [(unsat? candidate) (log 'synth "candidate is unsat")
                                #f]
            [else
            ;;;  (displayln "synth all-holes:")
            ;;;  (pretty-print all-holes) 
